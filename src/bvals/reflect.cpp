     ...
     FaceField &b, Real time, Real dt, int is, int ie, int js, int je, int ks, int ke)
{
  if (prim.data()!=NULL) {
    ...
    for (int n=0; n<(prim.GetDim4()); ++n) {
      if (n==(IVX) && prim.GetDim4()==4) { // only apply to mcoup and hydro arrays
        for (int k=ks; k<=ke; ++k) {
        for (int j=js; j<=je; ++j) {
#pragma simd
     ...
     FaceField &b, Real time, Real dt, int is, int ie, int js, int je, int ks, int ke)
{
   if (prim.data()!=NULL) {
    ...
    for (int n=0; n<(prim.GetDim4()); ++n) {
      if (n==(IVY) && prim.GetDim4()==4) { // only apply to mcoup and hydro arrays
        for (int k=ks; k<=ke; ++k) {
     ...
     FaceField &b, Real time, Real dt, int is, int ie, int js, int je, int ks, int ke)
{
  if (prim.data()!=NULL) {
    ...
    for (int n=0; n<(prim.GetDim4()); ++n) {
      if (n==(IVZ) && prim.GetDim4()==4) { // only apply to mcoup and hydro arrays
